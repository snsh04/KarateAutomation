...
Background: 
Given url 'https://wso2_username:wso2_password@bps-soam-1327-dev-a878-27-ams10-nonp.cloud.random.com/services/HumanTaskClientAPIAdmin/'
...
And soap action ''
Then status 200
* match /Envelope/Body/simpleQueryResponse/taskSimpleQueryResultSet/row[1]/presentationSubject contains 'Auto_ApprovalJ'
