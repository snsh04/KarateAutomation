...
public class AddAdvancedThrottlingPolicy {
...
//manage 
 ...
 // ((JavascriptExecutor) driver1).executeScript("window.scrollTo(0,document.body.scrollHeight)");
  ...
  // Select Tier
  driver1.findElement(By.id("apiTier")).click();
  driver1.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
  driver1.findElement(By.xpath("//*[@id=\"apiTier\"]/option[.='Tiered_Query_Param_Throttling']")).click();
  driver1.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
