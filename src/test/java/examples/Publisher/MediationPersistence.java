...
public class MediationPersistence {

 public static void main(String wso2username, String wso2password) throws InterruptedException {
 ...
 allCookies = driver1.manage().getCookies();
  ...
  loginThroughSSOForUser1(driver1,wso2username,wso2password);
 ...
 public static void loginThroughSSOForUser1(WebDriver driver1,String wso2username, String wso2password) throws InterruptedException {
  ...
  driver1.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
  driver1.findElement(By.id("password")).sendKeys(wso2password);
  driver1.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
  driver1.findElement(By.xpath("//*[@id=\"loginForm\"]/div[6]/div/button")).click();
  driver1.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);

  // search API by name
  driver1.findElement(By.xpath("//*[@id=\"listing\"]/div[2]/div/div[1]/div/form/div[1]/div/div/input[1]")).sendKeys("Regtest_Mediation");
  driver1.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
  ...
  driver1.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
  // in flow
  driver1.findElement(By.xpath("//*[@id=\"seqTable\"]/div[1]/div/div/div/button/span[1]")).click();
  driver1.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
  driver1.findElement(By.xpath("//*[@id=\"seqTable\"]/div[1]/div/div/div/div/ul/li[4]/a/span[.='json_to_xml_in_message']")).click();
  driver1.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);

  // out flow
  driver1.findElement(By.xpath("//*[@id=\"seqTable\"]/div[2]/div/div/div/button/span[1]")).click();
  driver1.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS); 
  driver1.findElement(By.xpath("//*[@id=\"seqTable\"]/div[2]/div/div/div/div/ul/li[5]/a/span[.='enable_akamai_cache_15min']")).click();
  driver1.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);

  // fault flow
  driver1.findElement(By.xpath("//*[@id=\"seqTable\"]/div[3]/div/div/div/button/span[1]")).click();
  driver1.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS); 
  driver1.findElement(By.xpath("//*[@id=\"seqTable\"]/div[3]/div/div/div/div/ul/li[4]/a/span[.='json_fault']")).click();
  driver1.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);

  // save 
  driver1.findElement(By.id("saveBtn")).click();
  driver1.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
  Thread.sleep(4000);
  // manage 
  driver1.findElement(By.id("go_to_manage")).click();
  driver1.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);

  // save and publish
  Thread.sleep(5000);
  driver1.findElement(By.id("publish_api")).click();
  driver1.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
  Thread.sleep(4000);
