...
public class DeletePersistence {
...
driver1.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
driver1.findElement(By.xpath("//*[@id=\"seqTable\"]/div[1]/div/div/div/div/ul/li[21]/a")).click();
driver1.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
// out flow
driver1.findElement(By.xpath("//*[@id=\"seqTable\"]/div[2]/div/div/div/button/span[1]")).click();
driver1.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
driver1.findElement(By.xpath("//*[@id=\"seqTable\"]/div[2]/div/div/div/div/ul/li[17]/a")).click();
driver1.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);

// fault flow
driver1.findElement(By.xpath("//*[@id=\"seqTable\"]/div[3]/div/div/div/button/span[1]")).click();
driver1.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
driver1.findElement(By.xpath("//*[@id=\"seqTable\"]/div[3]/div/div/div/div/ul/li[7]/a")).click();
driver1.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
// save 
