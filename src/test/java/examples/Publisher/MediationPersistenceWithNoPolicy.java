...
public class MediationPersistenceWithNoPolicy {
	...
	public static void loginThroughSSOForUser1(WebDriver driver1,String wso2username, String wso2password) throws InterruptedException {
		...
		driver1.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		// search API by name
	    driver1.findElement(By.xpath("//*[@id=\"listing\"]/div[2]/div/div[1]/div/form/div[1]/div/div/input[1]")).sendKeys("Regtest_NoMediation");
	    driver1.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
	    // click on search
		...
		driver1.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		Boolean Flag=driver1.findElement(By.xpath("//*[@id=\"implement_form\"]/fieldset/div/div/label/span")).isEnabled();
		driver1.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
