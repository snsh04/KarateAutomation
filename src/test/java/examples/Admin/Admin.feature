...
#----------------------**** ADMIN ****----------------------------------#
@Admin @All @parallel=false @randomAdmin @invalid
...
#-------------------------------------------------------------------------#
@Admin @All @parallel=false @randomAdmin @invalid
Scenario Outline: APIAdmin-Validate empty hostf for lambda api    
...
#-------------------------------------------------------------------------#
 ...
 @All @parallel=false @randomAdmin 
...
@Admin @All @parallel=false @Properties @addition
...
@Admin @All @parallel=false @Properties
...
@Admin @All @parallel=false @customheader
...
@Admin @All @parallel=false @randomAdmin @Check
...
@Admin @All @parallel=false @randomAdmin 
...
When method post
* retry until responseStatus == <responseCode> 
* match response.success == <success>
* call read('classpath:examples/Polling/Polling.feature') 
* def APPIDFromPublisher = call read('classpath:examples/Services/GetAPIIDFromPublisher.feature') {'title': '#(title)'  }
* def APIIDPub = APPIDFromPublisher.APIIDPub
* call read('classpath:examples/Services/DeleteAPI.feature')  {'APIIDPub': '#(APIIDPub)'  }
...
|true   |200         |'Regtest_Validate22'   | 'countryAdmin22'|'my API'    |'Flight'           |'contactme'|'contactme@random.com' |'regtest'            |'regtest@random.com'    |'techOwner'            |'techOwner@random.com' |'v70'   |null        |false |
...
Examples:
|success|responseCode|title                  |basepath         |description |domain             |contactName|contactEmail              |businessOwnerName    |businessOwnerEmail         |technicalOwnerName     |technicalOwnerEmail       |version |IncludeVersion|lambda|
|false  |200         |'Regtest_Validate(1)'  |'countryAdmin1'  |'my API'    |'test'             |'contactme'|'contactme@random.com' |'regtest'            |'regtest@random.com'    |'techOwner'            |'techOwner@random.com' |'v50'   |true        |true  |
|false  |200         |'Regtest_Validate6'    |'countryAdmin6'  |''          |'product'          |'contactme'|'contactme@random.com' |'regtest'            |'regtest@random.com'    |'techOwner'            |'techOwner@random.com' |'v55'   |true        |true  |
|false  |200         |'Regtest_Validate7'    |'countryAdmin7'  |'my API'    |'rubbish'          |'contactme'|'contactme@random.com' |'regtest'            |'regtest@random.com'    |'techOwner'            |'techOwner@random.com' |'v56'   |true        |true  |
|false  |200         |'Regtest_Validate10'   |'countryAdmin10' |'my API'    |'checkin'          |''         |''                        |''                   |'regtest@random.com'    |'techOwner'            |'techOwner@random.com' |'v59'   |true        |true  |
|false  |200         |'Regtest_Validate11'   |'countryAdmin11' |'my API'    |'loyalty'          |''         |''                        |'regtest'            |''                         |'techOwner'            |'techOwner@random.com' |'v60'   |true        |true  |
|false  |200         |'Regtest_Validate14'   |'countryAdmin14' |'my API'    |'virtualassistant' |''         |''                        |'regtest'            |'regtest@xyz.com'          |'techOwner'            |'techOwner@random.com' |'v63'   |true        |true  |
|false  |200         |'Regtest_Validate15'   |'countryAdmin15' |'my API'    |'test'             |'contactme'|'contactme@random.com' |'regtest'            |'regtest@random.com'    |'techOwner'            |'techOwner@random.com' |''      |true        |true  |
|false  |200         |'Regtest_Validate18'   |'countryAdmin18' |'my API'    |'employee'         |'contactme'|'contactme@random.com' |'regtest'            |'regtest@random.com'    |'techOwner'            |'techOwner@random.com' |'VV66'  |true        |true  |
|false  |200         |'Regtest_Validate19'   |'countryAdmin19' |'my API'    |'product'          |'contactme'|'contactme@random.com' |'regtest'            |'regtest@random.com'    |'techOwner'            |'techOwner@random.com' |'vv67'  |true        |true  |
|false  |200         |'Regtest_Validate16'   |'countryAdmin16' |'my API'    |'partner'          |'contactme'|'contactme@random.com' |'regtest'            |'regtest@random.com'    |''                     |'techOwner@random.com' |'v64'   |true        |true  |
|false  |200         |'Regtest_Validate17'   |'countryAdmin17' |'my API'    |'aircraft'         |'contactme'|'contactme@random.com' |'regtest'            |'regtest@random.com'    |'techOwner'            |''                        |'v65'   |true        |true  |


#-------------------------------------------------------------------------#

@All @Admin @parallel=false @randomAdmin 
...
@Admin @parallel=false @title @randomAdmin 
...
|'REGTEST_ACCESS3'|[DevTeamAlpha,DevTeam]     |500                     |'regtest_customer'     |'admin'    |'countryAccess3' |    
 ...
 @parallel=false @ADGroup @Admin @All @randomAdmin 
...
@parallel=false @ADGroup @Admin @All @description
